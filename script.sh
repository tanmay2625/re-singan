time python customSR.py --input_dir ./Input/customSR --input_name 11.png --noisy_input_name 24.png --sr_factor 2 --ker_size 2 --niter 1000  --lr_g 0.001 --lr_d 0.001 --custom_sr_alpha 20 --frozenWeight 0.7 --nc_im 1 --nc_z 1 --skip_training 0 --threshold 20
git add .
git commit -m "T=20"
time python customSR.py --input_dir ./Input/customSR --input_name 11.png --noisy_input_name 50.png --sr_factor 2 --ker_size 2 --niter 1000  --lr_g 0.001 --lr_d 0.001 --custom_sr_alpha 20 --frozenWeight 0.7 --nc_im 1 --nc_z 1 --skip_training 0 --threshold 200 
git add .
git commit -m "T=200"
